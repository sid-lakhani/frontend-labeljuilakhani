    ...
    <div className="prose lg:prose-lg max-w-full text-primary/70 ">
      <ReactMarkdown
        ...
        components={{
          ...
          ul: ({ children }) => <ul className="list-disc text-primary text-xs md:text-base lg:text-lg list-inside">{children}</ul>,
          ol: ({ children }) => <ol className="list-decimal text-primary text-xs md:text-base lg:text-lg list-inside">{children}</ol>,
          ...
          strong: ({ children }) => <strong className="text-primary font-bold text-xs md:text-base lg:text-lg ">{children}</strong>,
        }}
      >
        {content}
      </ReactMarkdown>
