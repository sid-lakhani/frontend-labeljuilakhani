...
export default function Footer() {
  return (
    <div className="h-[45dvh] md:h-[40dvh] flex flex-col md:flex-row items-center justify-center md:justify-evenly my-[2%] mx-[2%] gap-8 md:gap-0 bg-black/10 md:bg-inherit">
