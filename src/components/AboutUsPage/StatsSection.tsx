  ...
  return (
    <div className="w-screen py-20 px-5 md:px-[15%]">
      <div className="flex flex-col md:flex-row justify-center items-center w-full gap-4 md:gap-0">
        <h1 className="w-full md:w-1/2 font-playfair text-2xl md:text-3xl lg:text-4xl text-black/90 tracking-tighter">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 mt-16 text-black/50 text-xs md:text-sm tracking-tight leading-loose">
        <div>
