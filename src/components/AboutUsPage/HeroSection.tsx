  ...
  return (
    <div className="min-h-screen w-screen px-[5%] md:px-[10%] lg:px-[20%] pt-28 md:pt-40">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 mt-8">
        ...
        <div className="md:w-1/3 flex flex-col justify-start gap-10 md:gap-12  md:text-start">
          <p className="hidden md:block text-sm uppercase tracking-[0.5em] font-montserrat font-medium text-black/80">
            Meet THE FOUNDER
          </p>
          <p className="text-4xl lg:text-5xl font-playfair text-primary tracking-tighter md:mt-2">
            Crafted with love, worn with grace.
          </p>
          <div>
            <p className="font-sen text-sm md:text-base lg:text-lg md:mt-6 text-black/60 tracking-tight">
            ...
            <Link href={"/customs"}>
              <button className="mt-8 py-2 px-8 md:px-16 md:py-4 text-quaternary font-montserrat font-bold text-xs md:text-sm bg-[#A18668] uppercase hover:underline">
                Contact Us
              </button>
            </Link>
          </div>
