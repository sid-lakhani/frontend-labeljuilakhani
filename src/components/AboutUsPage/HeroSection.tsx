...
export default function HeroSection() {
  return (
    <div className="h-fit w-screen px-[5%] md:px-[8%] lg:px-[20%] pt-28 md:pt-40">
      ...
      <div className="h-full flex flex-col md:flex-row justify-center gap-8 mt-8">
        ...
        <div className="md:w-1/3 flex flex-col justify-start lg:justify-start gap-10 md:gap-4 lg:gap-8 md:text-start">
          <p className="hidden md:block md:text-xs text-sm uppercase tracking-[0.5em] font-montserrat font-medium text-black/80">
            Meet THE FOUNDER
          </p>
          ...
          <div>
            <p className="font-sen text-sm md:text-base lg:text-lg lg:mt-6 text-black/60 tracking-tight">
