...
export default function Testimonials() {
  ...
  return (
    <div className="h-fit mt-20 flex flex-col">
      {/* Heading Section */}
      <div className="font-playfair flex flex-col justify-end px-[5%] md:px-[10%] lg:px-[20%] text-[10vw] md:text-7xl lg:text-[5vw] text-secondary tracking-tighter text-right">
        <p className="text-xs md:text-sm uppercase tracking-[0.5em] font-montserrat font-medium">
          Testimonial
        </p>
        <p className="italic leading-[0.9]">Client's</p>
        ...
        <p className="uppercase leading-[0.9]">
          <span className="italic lowercase">
            love <span className="uppercase">We</span>
          </span>{" "}
          Create
        </p>
      </div>
